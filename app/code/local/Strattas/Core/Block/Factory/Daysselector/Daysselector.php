...
class Strattas_Core_Block_Factory_Daysselector extends Mage_Adminhtml_Block_Widget implements Varien_Data_Form_Element_Renderer_Interface
{
    public function __construct()
    {
        $this->setTemplate('strattas_core/factory/daysselector.phtml');
    }
